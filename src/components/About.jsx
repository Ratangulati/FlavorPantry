    ...
    <section className='flex flex-col md:flex-row items-center justify-center px-8 py-15 m-20 gap-25 max-w-6xl mx-auto bg-white'>
      ...
      <div className='flex-1 text-left'>
        ...
        <p className='text-gray-700 text-lg leading-relaxed'>
          No need to rush to the store! Just enter the ingredients already in
          your pantry, and FlavorPantry will whip up tailored recipes you’ll
          love. Save time, reduce food waste, and cook creatively.
        </p>
      </div>
    </section>
  );
