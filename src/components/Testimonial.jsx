...
const Testimonials = () => {
  return (
    <section className="bg-white py-20 px-6">
      <h2 className="text-4xl font-bold text-green-600 text-center mb-12">What People Say</h2>
      <div className="flex flex-col md:flex-row justify-center gap-8">
        {testimonials.map(({ img, text }, i) => (
          <div key={i} className="bg-gray-100 p-6 rounded-xl shadow-lg text-left flex-1">
            <img src={img} alt="testimonial" className="w-28 h-28 object-cover rounded-full mx-auto mb-4" />
