  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <main className='max-w-[1200px] mx-auto mt-20 mb-10 p-5'>
        <h1 className='text-green-600 text-4xl text-center mt-5 font-bold'>
          Cook It Now
        </h1>
        ...
        <section className='flex flex-col md:flex-row gap-8 mb-10'>
          <div className='bg-white p-6 rounded-lg shadow-lg flex-1'>
            <h2 className='text-green-600 text-2xl mb-4 font-semibold'>
              My Pantry
            </h2>
          ...
          <div className='bg-white p-6 rounded-lg shadow-lg flex-1'>
            ...
            <button
              onClick={findRecipes}
              className='w-full mt-5 bg-green-600 text-white py-3 rounded-md font-medium'
            >
              Find Recipes
            </button>
          </div>
        ...
        <section className='mt-8'>
          <h2 className='text-green-600 text-2xl mb-5 font-semibold'>
            Recipes You Can Make
          </h2>

          {loading && (
            <div className='flex justify-center'>
              <div className='border-4 border-gray-100 border-t-green-600 rounded-full w-10 h-10 animate-spin'></div>
            </div>
          )}
          {error && (
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            {meals.map(meal => (
              <div
                key={meal.idMeal}
                className='bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer hover:-translate-y-1 transition'
              >
                <img
